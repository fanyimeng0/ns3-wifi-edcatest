...
#ifndef MYONOFF_APPLICATION_H
#define MYONOFF_APPLICATION_H
...
public:
  ...
  void SetTagvalue(uint64_t  tagvalue);
...
private:
  ...
  vector<double>  m_pakvec;
  vector<double>  m_timevec;
